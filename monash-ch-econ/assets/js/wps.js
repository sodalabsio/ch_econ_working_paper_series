$(document).ready(function() {
    ...
    const apiEndpoint = "https://ryenw3e2e6.execute-api.ap-southeast-2.amazonaws.com/v1/upload"
    ...
    let currentPapers = 0;
    let prefix = `RePEc/edi/chmonau/${currentYear}-`;
    // AWS credentials
    let bucketName = "monash-ch-econ-wps";
